...
export function createOriginSphere(origin:number[],ras:number[],spacing:number[],x_bias:number,y_bias:number,z_bias:number){
  ...
  const resetOrigin = [origin[0]+x_bias,origin[1]+y_bias,origin[2]+z_bias]

  spherelt.position.set(resetOrigin[0],resetOrigin[1],resetOrigin[2])
  spherert.position.set(resetOrigin[0]+ras[0],resetOrigin[1],resetOrigin[2])
  spherelb.position.set(resetOrigin[0],resetOrigin[1]+ras[1],resetOrigin[2])
  sphererb.position.set(resetOrigin[0]+ras[0],resetOrigin[1]+ras[1],resetOrigin[2])
...
export function getClosestNipple(nippleLeft:THREE.Vector3,nippleRight:THREE.Vector3, tumourCenter:THREE.Vector3){
